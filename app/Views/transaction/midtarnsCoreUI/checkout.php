                                    ...
                                    <div class="modal-body">
                                        <div class="row row-cols-1">
                                            ...
                                            <div class="col">
                                                <div class="row">
                                                    <div class="col d-flex align-items-center">
                                                        <img src="<?= base_url(); ?>assets/img/checkout/jne.png" alt="Jne" srcset="" style="width: 90px;">
                                                    </div>
                                                    <div class="col d-flex justify-content-end">
                                            ...
                                            <div class="col">
                                                <div class="row">
                                                    <div class="col d-flex align-items-center">
                                                        <img src="<?= base_url(); ?>assets/img/checkout/pos.png" alt="Pos" srcset="" style="width: 85px;">
                                                    </div>
                            ...
                            <div class="col pt-1">
                                <div class="card border-0 shadow-sm">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-1">
                                                <img src="<?= base_url(); ?>assets/img/produk/main/<?= $p['img_produk']; ?>" alt="" class="card-img" style="width:35px; object-fit: contain; object-position: 20% 10%;">
                                            </div>
                                            <div class="col-7 keterangan position-absolute top-50 start-50 translate-middle">
                                                <p class="card-title pemilihan" style="font-size: 10px;"><?= substr($p['nama'], 0,); ?></p>
                                                <p class="card-text text-secondary pemilihan" style="font-size: 9px;"><?= $p['qty']; ?> Pcs
                                                </p>
                                            </div>
                                            <div class="col-3 keterangan position-absolute top-50 end-0 translate-middle-y mt-2 ps-4">
                                                <p class="text-secondary pemilihan" style="font-size: 12px;">Total</p>
                                                <p class="fw-bold" style="font-size: 10px;">Rp. <?= number_format(($p['harga_item'] * $p['qty']), 0, ',', '.'); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card border-0 shadow-sm rounded-2 mb-3">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="icons">
                                                    <img src="<?= base_url('assets/img/checkout/bank/'); ?>bca.png" width="60">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card border-0 shadow-sm rounded-2 mb-3">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="icons">
                                                    <img src="<?= base_url('assets/img/checkout/bank/'); ?>mandiri.png" width="60">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-md-4 order-md-2 mb-4">
                        ...
                        <div class="d-grid gap-2">
                            <button type="button" class="btn btn-lg fw-bold rounded btn-bayar mt-3" style="background-color: #ec2614; color: #fff; width: 100%;" data-bs-toggle="modal" data-bs-target="#metode-pembayaran-modal">Pilih Metode Pembayaran</button>
                        </div>
                    </div>
                    <!-- Left Panel -->
