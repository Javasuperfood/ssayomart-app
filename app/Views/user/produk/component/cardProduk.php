    ...
    <div class="container bg-white" id="product">
        ...
        <div class="row row-cols-3" id="product-container">
            ...
            <?php foreach ($produk as $p) : ?>
                <div class="col-4 col-md-2 col-lg-2 mb-3 susunan-card d-flex justify-content-center align-items-center">
                    <div class="">
                        <div class="card card-produk border-0 shadow-sm text-center" style="width: 105px; height: 100%;">
                            ...
                            <div class="fs-2 mt-2" style="padding: 0 10px 0 10px;">
                                ...
                                <h1 class="text-danger fw-bold mt-1 mb-1 fw-bold" style="font-size: 10px; margin: 0;">
