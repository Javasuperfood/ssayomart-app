                                ...
                                <div class="col-4 col-md-2 col-lg-2 mb-3 susunan-card">
                                    <div class="card card-zoom card-produk border-0 shadow-sm text-center" style="width: 105px; height: 100%; padding: 5px;">
                                        ...
                                        <div class="fs-2 mt-2" style="padding: 0 10px 0 10px;">
                                            <div class="d-flex align-items-start justify-content-center" style=" height: 85px;">
                ...
                <section class="mt-1">
                    <div class="card font-family-poppins border-0" style="background-color: #fecdce; display: grid; grid-template-columns: 1fr auto; align-items: center; padding: 1rem; font-size: 12px;">
                        ...
                        <a style="color: #7e0204;" href="<?= base_url(); ?>all-category" id="goToCategories" class="fw-bold text-decoration-none">
                            <span class="text-secondary fw-bold" style="font-size: 14px;"><?= lang('Text.go_to_kategori_kr') ?></span>
                            <br>
                            <span class="fw-bold" style="font-size: 16px;"><?= lang('Text.go_to_kategori_id_en') ?></span>
                        </a>
                                    ...
                                    <div class="swiper-wrapper d-flex mb-3">
                                        <?php foreach ($randomProducts as $p) : ?>
                                            <div class="swiper-slide col-md-4 mx-md-1 mb-md-1">
                                                <div class="produk-zoom card border-0 shadow-sm" style="width: 195px; height: 100%; padding: 5px;">
                                                    <a href="<?= base_url() ?>produk/<?= $p['slug']; ?>" class="link-underline link-underline-opacity-0">
                                                        <div class="d-flex justify-content-center align-items-center">
                                                    ...
                                                    <div class="fs-2 mt-2" style="padding: 0 10px 0 10px;">
                                                        <div class="d-flex text-center align-items-center justify-content-center" style="height: 75px;">
                                                        ...
                                                        <h1 class="mb-3 text-danger fw-bold mt-4 text-center" style="font-size: 15px; margin: 0;">
                                                            <?php if ($p['harga_min'] == $p['harga_max']) : ?>
                                                                Rp. <?= number_format($p['harga_min'], 0, ',', '.'); ?>
                                                            <?php else : ?>
                                                                <?= substr('Rp. ' . number_format($p['harga_min'], 0, ',', '.') . '-' . number_format($p['harga_max'], 0, ',', '.'), 0, 13); ?>...
