            ...
            <div class="card mb-4">
                <div class="card-body">
                    <div class="form-outline mb-4">
                        ...
                        <input type="search" class="form-control" id="search-input" placeholder="kamun bisa cari Nama produk, No pesananan disini ">
                    </div>
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-5 position-absolute top-50 start-50 translate-middle">
                                    <h5 class="card-title fs-2"><?= substr($t->nama, 0, 10); ?>...</h5>
                                    <p class="text-secondary fs-1">Rp. <?= number_format($t->harga, 0, ',', '.'); ?></p>
                                </div>
