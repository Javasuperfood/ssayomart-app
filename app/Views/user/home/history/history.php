                                    ...
                                    <div class="row">
                                        <?php if ($t->snap_token != null) : ?>
                                            ...
                                            <?php elseif ($t->id_status_pesan == 3) : ?>
                                                <div class="col-4 position-absolute top-50 end-0 translate-middle-y">
                                                    <a href="<?= (!$t->gosend) ? base_url('status?order_id=' . $t->invoice) : base_url('status/ordering?order_id=' . $t->invoice); ?>" class="btn btn-outline-success custom-btn">
                                            ...
                                            <?php else : ?>
                                                <div class="col-4 position-absolute top-50 end-0 translate-middle-y">
                                                    <a href="<?= (!$t->gosend) ? base_url('status?order_id=' . $t->invoice) : base_url('status/ordering?order_id=' . $t->invoice); ?>" class="btn btn-outline-success custom-btn">Detail</a>
                                                </div>
                                            <?php endif ?>
                                        <?php else : ?>
                                            <div class="col-4 position-absolute top-50 end-0 translate-middle-y">
