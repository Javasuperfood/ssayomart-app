            ...
            <div class="container mt-5">
                ...
                <div class="row row-cols-1">
                    <div class="col">
                        ...
                        <ul class="list-group list-group-flush">
                            <a href="<?= base_url(); ?>setting/detail-user" class="list-group-item fw-bold border border-secondary border-opacity-10 shadow-sm rounded-3 mb-2 p-3">
                                <i class="bi bi-person-circle pe-2 text-secondary"></i>
                                <span class="text-secondary"><?= lang('Text.detail_akun') ?></span>
                                <i class="bi bi-chevron-right fw-bolder position-absolute top-50 end-0 mx-2 translate-middle-y"></i>
                            </a>
                            <a href="<?= base_url(); ?>setting/alamat-list" class="list-group-item fw-bold border border-secondary border-opacity-10 shadow-sm rounded-3 p-3">
                                <i class="bi bi-cursor pe-2 text-secondary"></i>
                                <span class="text-secondary"> <?= lang('Text.alamat_tersimpan') ?> </span>
                                <i class="bi bi-chevron-right fw-bolder position-absolute top-50 end-0 mx-2 translate-middle-y"></i>
                            </a>
                        </ul>
                    </div>
                ...
                <div class="row row-cols-1 mt-4">
                    <div class="col">
                        ...
                        <ul class="list-group list-group-flush">
                            <!-- About Section -->
                            <a href="<?= base_url('setting/sayo-care'); ?>" class="list-group-item fw-bold border border-secondary border-opacity-10 shadow-sm rounded-3 mb-2 p-3">
                                <i class="bi bi-question-circle pe-2 text-secondary"></i>
                                <span class="text-secondary"><?= lang('Text.tentang') ?></span>
                                <i class="bi bi-chevron-right fw-bolder position-absolute top-50 end-0 mx-2 translate-middle-y"></i>
                            </a>

                            <!-- Help Center Section -->
                            <a href="<?= base_url('/pusat-bantuan'); ?>" class="list-group-item fw-bold border border-secondary border-opacity-10 shadow-sm rounded-3 mb-2 p-3">
                                <i class="bi bi-universal-access-circle pe-2 text-secondary"></i>
                                <span class="text-secondary"><?= lang('Text.pusat_bantuan') ?></span>
                                <i class="bi bi-chevron-right fw-bolder position-absolute top-50 end-0 mx-2 translate-middle-y"></i>
                            </a>

                            <!-- Privacy Policy Section -->
                            <a href="<?= base_url('setting/kebijakan-privasi'); ?>" class="list-group-item fw-bold border border-secondary border-opacity-10 shadow-sm rounded-3 mb-2 p-3">
                                <i class="bi bi-lock pe-2 text-secondary"></i>
                                <span class="text-secondary"><?= lang('Text.kebijakan_privasi') ?></span>
                                <i class="bi bi-chevron-right fw-bolder position-absolute top-50 end-0 mx-2 translate-middle-y"></i>
                            </a>

                            <!-- Logout Section (Modal Trigger) -->
                            <span data-bs-toggle="modal" data-bs-target="#modalLogout" class="list-group-item fw-bold border border-secondary border-opacity-10 shadow-sm rounded-3 mb-2 p-3" role="button" tabindex="0">
                                <i class="bi bi-box-arrow-right pe-2 text-secondary"></i>
                                <span class="text-secondary"><?= lang('Text.logout') ?></span>
                                <i class="bi bi-chevron-right fw-bolder position-absolute top-50 end-0 mx-2 translate-middle-y"></i>
                            </span>
