        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-floating mb-3">
                    <input type="password" name="oldPass" class="form-control <?= (validation_show_error('oldPass')) ? 'is-invalid' : ''; ?>" id="oldPass" placeholder="password">
            ...
            <div class="col-md-6">
                <div class="form-floating mb-3">
                    <input type="password" name="newPass" class="form-control <?= (validation_show_error('newPass')) ? 'is-invalid' : ''; ?>" id="newPass" placeholder="password">
            ...
            <div class="col-md-6">
                <div class="form-floating mb-3">
                    <input type="password" name="reNewPass" class="form-control <?= (validation_show_error('reNewPass')) ? 'is-invalid' : ''; ?>" id="newPass" placeholder="password">
