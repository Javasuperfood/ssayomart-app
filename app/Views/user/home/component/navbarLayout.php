        ...
        <nav class="navbar navbar-main rounded-bottom-4 shadow-sm" style="background-color:#ffff;">
            <div class="container-fluid p-2 mx-auto" style="z-index: 2;">
                <div class="row w-100 align-items-center justify-content-between">
                    <div class="col">
                        <div class="border-0 mt-lg-3 d-flex align-items-center justify-content-center ms-5">
                            <?php if (isset($back)) : ?>
                                <?php $displayTitle = strlen($title) > 20 ? substr($title, 0, 20) . '...' : $title; ?>
