...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="<?= base_url(); ?>dashboard/tambah-kupon">Tambah Kupon</a></li>
</ul>
...
<a class="btn btn-danger mb-3" href="<?= base_url(); ?>dashboard/tambah-kupon">Tambah Baru</a>
