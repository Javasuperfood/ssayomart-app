            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="collapse show" id="deskripsi">
                    <div class="card-body">
                        ...
                        <textarea class="form-control border-0 shadow-sm <?= (validation_show_error('deskripsi')) ? 'is-invalid' : ''; ?>" placeholder="Deskripsi Market" name="deskripsi" id="floatingTextarea2" style="height: 100px"><?= old('deskripsi'); ?></textarea>
                    </div>
                </div>
            </div>
            <div class="card border-0 shadow-sm mb-4">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3 mx-3 my-3">
                                    ...
                                    <input class="form-control border-0 shadow-sm" placeholder="Telepon" name="telp" value="<?= old('telp') ?>" onkeypress="return isNumber(event);">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3 mx-3 my-3">
                                    <input class="form-control border-0 shadow-sm" placeholder="Telepon 2" name="telp2" value="<?= old('telp2') ?>" onkeypress="return isNumber(event);">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="mb-3 mx-3 my-3">
                                    ...
                                    <input class="form-control border-0 shadow-sm" placeholder="Kode Pos" name="zip_code" value="<?= old('telp') ?>" onkeypress="return isNumber(event);">
                                </div>
                                <div class="mb-3 mx-3 my-3">
                                    <div class="text-danger pb-1">
                                ...
                                <div class=" mb-3 mx-3 my-3">
                                    ...
                                    <textarea class="form-control border-0 shadow-sm" name="alamat_1" placeholder="Alamat Market" id="floatingTextarea2" style="height: 100px"><?= old('alamat_1') ?></textarea>
                                </div>
                                <div class=" mb-3 mx-3 my-3">
                                    <textarea class="form-control border-0 shadow-sm" name="detail-alamat" placeholder="Detail Alamat" id="floatingTextarea2" style="height: 100px"><?= old('detail-alamat') ?></textarea>
                                </div>
