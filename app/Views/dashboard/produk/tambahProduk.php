...
<div class="card border-1 shadow-sm position-relative mb-5">
    ...
    <div class="card-body">
        ...
        <form action="<?= base_url(); ?>dashboard/produk/tambah-produk/save" method="post" enctype="multipart/form-data">
            <?= csrf_field(); ?>
            <div class="mb-4">
                <label for="nama" class="form-label">Nama Produk dalam <strong>Bahasa Indonesia</strong><span class="text-danger"> *</span></label>
            ...
            <div class="mb-4">
                ...
                <input type="text" class="form-control shadow-sm border-0 <?= (validation_show_error('nama_kr')) ? 'is-invalid' : 'border-1'; ?>" id="nama_kr" name="nama_kr" data-toggle="tooltip" data-placement="bottom" title="Harap isi bidang ini dengan nama produk" placeholder="Nama Produk Anda dalam Bahasa korea..." value="<?= old('nama_kr') ?>"">
    ...
    <div class="mb-4">
        ...
        <input type="text" class="form-control shadow-sm border-0 <?= (validation_show_error('nama_en')) ? 'is-invalid' : 'border-1'; ?>" id="nama_en" name="nama_en" data-toggle="tooltip" data-placement="bottom" title="Harap isi bidang ini dengan nama produk" placeholder="Nama Produk Anda dalam bahasa inggris..." value="<?= old('nama_en') ?>"">
...
<div class="mb-4">
    ...
    <select class="form-control shadow-sm border-0 <?= (validation_show_error('parent_kategori_id')) ? 'is-invalid' : 'border-1'; ?>" id="kategori" name="parent_kategori_id" data-toggle="tooltip" data-placement="bottom" title="Klik untuk memilih kategori produk yang anda inputkan">
...
<div class="mb-4">
    <div class="row">
        <div class="col-md-6">
            ...
            <select class="form-control border-0 shadow-sm" name="selectVariant" data-toggle="tooltip" data-placement="bottom" title="Klik untuk memilih varian produk yang anda inputkan" id="selectVariant">
        ...
        <div class="col-md-6">
            ...
            <input type="text" id="valueItem" name="valueItem" class="form-control shadow-sm border-0 <?= (validation_show_error('value_item')) ? 'is-invalid' : 'border-1'; ?>" value="<?= old('valueItem') ?>" placeholder="Value Varian" name="parent_kategori_id" data-toggle="tooltip" data-placement="bottom" title="Harap isi bidang ini dengan value produk yang anda inputkan">
            <div class="invalid-feedback"><?= validation_show_error('value_item'); ?></div>
        </div>
    </div>
</div>
<div class="mb-4">
    <label for="berat" class="form-label">Berat Produk <span class="text-danger">*</span><span class="text-secondary">( Harus Dalam Satuan Gram e.g : 1kg = 1000)</span></label>
