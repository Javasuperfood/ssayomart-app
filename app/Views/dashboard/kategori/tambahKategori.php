        ...
        <div class="card border-0 shadow-sm shadow-sm position-relative">
            ...
            <div class="card-body">
                <form action="<?= base_url(); ?>dashboard/kategori/tambah-kategori/save" method="post" enctype="multipart/form-data">
                    ...
                    <div class="alert alert-danger text-center border-0 shadow-sm shadow-sm my-4" role="alert">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="file" class="form-control <?= (validation_show_error('img')) ? 'is-invalid' : 'border-0 shadow-sm'; ?>" id="img" name="img" accept="image/*">
                        <div class="invalid-feedback"><?= validation_show_error('img'); ?></div>
                    </div>

                    <div class="mb-4">
                        <label for="exampleFormControlTextarea1" class="form-label">Deskripsi</label>
                        <textarea type="text" class="form-control <?= (validation_show_error('deskripsi')) ? 'is-invalid' : 'border-0 shadow-sm'; ?>" id="deskripsi" rows="3" placeholder="Masukan deskripsi kategori atau sub kategori" name="deskripsi" value="<?= old('deskripsi') ?>"></textarea>
