        ...
        <div class="card border-1 shadow-sm shadow-sm position-relative">
            ...
            <div class="card-body">
                <form action="<?= base_url(); ?>dashboard/kategori/tambah-kategori/save" method="post" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    <div class=" mb-4">
                        <label for="nama_kategori" class="form-label">Nama Kategori atau Sub Kategori Bahasa Indonesia<span class="text-danger"> *</span></label>
                        <input type="text" class="form-control border-0 shadow-sm <?= (validation_show_error('nama_kategori')) ? 'is-invalid' : 'border-1'; ?>" id="kategori" data-toggle="tooltip" data-placement="bottom" title="Harap isi bidang ini dengan Nama Kategori atau Sub-Kategori dalam bahasa Indonesia" placeholder="Masukan nama kategori atau sub kategori" name="nama_kategori" value="<?= old('nama_kategori') ?>">
                        <div class="invalid-feedback"><?= validation_show_error('nama_kategori'); ?></div>
                    </div>
                    <div class=" mb-4">
                        <label for="nama_kategori_en" class="form-label">Nama Kategori atau Sub Kategori Bahasa Inggris<span class="text-danger"> *</span></label>
                        <input type="text" class="form-control border-0 shadow-sm <?= (validation_show_error('nama_kategori_en')) ? 'is-invalid' : 'border-1'; ?>" id="kategori" data-toggle="tooltip" data-placement="bottom" title="Harap isi bidang ini dengan Nama Kategori atau Sub-Kategori dalam bahasa Inggris" placeholder="Masukan nama kategori atau sub kategori" name="nama_kategori_en" value="<?= old('nama_kategori_en') ?>">
                        <div class="invalid-feedback"><?= validation_show_error('nama_kategori_en'); ?></div>
                    </div>
                    <div class=" mb-4">
                        <label for="nama_kategori_kr" class="form-label">Nama Kategori atau Sub Kategori Bahasa Korea<span class="text-danger"> *</span></label>
                        <input type="text" class="form-control border-0 shadow-sm <?= (validation_show_error('nama_kategori_kr')) ? 'is-invalid' : 'border-1'; ?>" id="kategori" data-toggle="tooltip" data-placement="bottom" title="Harap isi bidang ini dengan Nama Kategori atau Sub-Kategori dalam bahasa Korea" placeholder="Masukan nama kategori atau sub kategori" name="nama_kategori_kr" value="<?= old('nama_kategori_kr') ?>">
                    ...
                    <select class="form-control border-0 shadow-sm border-1" id="parent_kategori_id" name="parent_kategori_id" data-toggle="tooltip" data-placement="bottom" title="Harap Kosongkan apabila kategori utama">
                        <option value="">Pilih Kategori Induk (KOSONGKAN INI JIKA ANDA INGIN MENAMBAHKAN KATEGORI INDUK)</option>
                    ...
                    <div class="mb-4">
                        ...
                        <label for="img" class="form-label" data-toggle="tooltip" data-placement="bottom" title="Harap isi bidang ini dengan gambar kategori">Masukan Gambar<span class="text-danger"> *</span></label>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea type="text" class="form-control border-0 shadow-sm <?= (validation_show_error('deskripsi')) ? 'is-invalid' : 'border-1'; ?>" id="deskripsi" data-toggle="tooltip" data-placement="bottom" title="Harap isi bidang ini dengan Deskripsi" rows="3" placeholder="Masukan deskripsi kategori atau sub kategori" name="deskripsi"><?= old('deskripsi') ?></textarea>
                        <div class="invalid-feedback"><?= validation_show_error('deskripsi'); ?></div>
                    </div>
                    <div class="d-flex justify-content-center">
                        <button type="submit" class="btn btn-outline-danger" onclick="clickSubmitEvent(this)"><i class="bi bi-plus-circle text-danger"></i>&nbsp;Tambah Kategori</button>
                    </div>
                </form>
            </div>
        </div>
