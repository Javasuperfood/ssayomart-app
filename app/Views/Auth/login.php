        ...
        <div class="forms-wrap">
            <form action="<?= url_to('login') ?>" method="post" onsubmit="playPreloaderEvent()">
                ...
                <div class="actual-form">
                    ...
                    <a href="<?= base_url('callback-apple'); ?>" class="button justify-content-center align-items-center my-3" style="border: 1px solid #000000;">
                        ...
                        <?= lang('Text.login_apple') ?> With Controller
                    </a>
                    ...
                    <a id="btn-login-apple" class="button justify-content-center align-items-center my-3" style="border: 1px solid #000000;">
                        ...
                        <?= lang('Text.login_apple') ?> Using JS
                    </a>
