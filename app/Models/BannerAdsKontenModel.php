...
class BannerAdsKontenModel extends Model
{
    protected $DBGroup          = 'default';
    protected $table            = 'jsf_ads_konten';
    protected $primaryKey       = 'id_ads_konten';
    ...
    protected $validationRules      = [
        ...
        'img' => [
            ...
            'errors' => [
                ...
                'mime_in' => 'Format gambar tidak sesuai. image/jpg/jpeg/png',
            ]
        ]
    ];
